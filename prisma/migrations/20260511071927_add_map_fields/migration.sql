...
CREATE TABLE "new_SiteContent" (
    ...
    "mapLat" REAL NOT NULL DEFAULT 50.876200,
    "mapLng" REAL NOT NULL DEFAULT 4.701500,
    "mapZoom" INTEGER NOT NULL DEFAULT 17,
    "mapHeading" TEXT NOT NULL DEFAULT 'come find us',
    "mapSub" TEXT NOT NULL DEFAULT 'Naamsestraat 55P, 3000 Leuven',
    "updatedAt" DATETIME NOT NULL
);
INSERT INTO "new_SiteContent" ("addressLine1", "addressLine2", "bgImagePath", "brandName", "definitionBody", "definitionLabel", "findUsLabel", "findUsUrl", "hoursToday", "hoursWeekend", "id", "instaCtaLabel", "instaEmbedHtml", "instaHeading", "instaSub", "instagramHandle", "instagramUrl", "inviteLine", "inviteSub", "isOpen", "metaDescription", "metaTitle", "statusLabel", "statusSub", "tagline", "updatedAt") SELECT "addressLine1", "addressLine2", "bgImagePath", "brandName", "definitionBody", "definitionLabel", "findUsLabel", "findUsUrl", "hoursToday", "hoursWeekend", "id", "instaCtaLabel", "instaEmbedHtml", "instaHeading", "instaSub", "instagramHandle", "instagramUrl", "inviteLine", "inviteSub", "isOpen", "metaDescription", "metaTitle", "statusLabel", "statusSub", "tagline", "updatedAt" FROM "SiteContent";
