...
INSERT INTO "new_SiteContent" ("addressLine1", "addressLine2", "bgImagePath", "brandName", "definitionBody", "definitionLabel", "findUsLabel", "findUsUrl", "hoursToday", "hoursWeekend", "id", "instagramHandle", "instagramUrl", "isOpen", "metaDescription", "metaTitle", "statusLabel", "statusSub", "tagline", "updatedAt") SELECT "addressLine1", "addressLine2", "bgImagePath", "brandName", "definitionBody", "definitionLabel", "findUsLabel", "findUsUrl", "hoursToday", "hoursWeekend", "id", "instagramHandle", "instagramUrl", "isOpen", "metaDescription", "metaTitle", "statusLabel", "statusSub", "tagline", "updatedAt" FROM "SiteContent";
